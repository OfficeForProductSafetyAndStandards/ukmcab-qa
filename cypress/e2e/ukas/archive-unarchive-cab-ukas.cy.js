...
describe("Request to Unarchive a CAB", () => {
    ...
    context.only("and save as draft; Declined", function () {
        ...
        it("sent email to UKAS that request to un-archive and save as draft has been declined", function () {
        ...
        it("UKAS receives notification for declined request to un-archive and save as draft CAB", function () {
            cy.loginAsUkasUser();
            cy.ensureOn(CabHelpers.notificationCompletedUrlPath());
            cy.get('#tab_completed').click();
            cy.contains("tr", "Unarchive CAB request")
