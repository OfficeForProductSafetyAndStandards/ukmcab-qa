...
describe('Footer', function() {
  ...
  it('displays all expected links', function() {
    ...
    footer().contains('a', 'Department for Business & Trade (opens in a new window)').should('have.attr', 'href', 'https://www.gov.uk/government/organisations/department-for-business-and-trade').and('have.attr', 'target', '_blank')
